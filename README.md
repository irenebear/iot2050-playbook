...
### Industrial Control & Communication (CODESYS / OPC UA)
...
### Cloud Connectivity (Data to Cloud)
...
- [Connect the IoT2050 to Alibaba Cloud IoT Platform](docs/IoT2050_Aliyun_IoT_MQTT.md) — 15 lines of stdlib HMAC-SHA256, MQTT uplink in 30 minutes.
